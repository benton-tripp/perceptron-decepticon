...
\[ 
  ...
  \text{the dot product } \vec{x} \cdot \vec{w} = \sum_{i=1}^k \vec{x}\vec{w} \text{ where } k \text{ is the number of inputs, and } b \text{ is the bias.}
  \]
...
Here is the full R script, with the prior steps defined as functions:
